...
class OnlyKey(object):
    def __init__(self, connect=True, tries=5):
    ...
    def _connect(self):
        try:
            ...
            if not hasattr(self,"_hid"):
                raise RuntimeError("Unable to connect to OnlyKey")

        except Exception as Error:
            log.debug('failed to connect')
            raise OnlyKeyUnavailableException() and Error
